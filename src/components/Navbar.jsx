...
const Navbar = () => {
  ...
  // const phrases = ["Gold", "Diamond", "Rings", "Earrings", "Necklace"];
...
{/* 
<div className="nav-search">
      <span className="search-static">Search for&nbsp;</span>
      <span className="search-dynamic">{phrases[index]}</span>
      <FaSearch className="search-icon" />
      <IoIosMicrophone className="mic-icon" />
    </div> */}
...
//             <div className="relative">
//               <NavLink to="/cart"> {/* Wrap the cart icon with Link to Cart page */}
//                 <FaShoppingCart className="cart-icon" title="Cart" />
//                 {cartItems.length > 0 && (
//                   <span className="cart-count absolute -top-2 -right-2 bg-red-500 text-white text-xs rounded-full px-1">
//                     {cartItems.length}
